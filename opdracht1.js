...
// const allTvTypes = inventory.map(() => {
//     inventory.type;
// })
//
...
console.log(allTvTypes);
// console.log(inventory.filter(type));
...
// const soldTvs = inventory.filter(() => {
//     inventory.originalStock - inventory.sold === 0;
// })
//
// console.log(soldTvs);

const soldTvs = inventory.filter((tv) => {
...
const lowToHigh = inventory.sort((a,b) => {
    if (a.price < b.price) {
        return -1;
    }
    if (a.price > b.price) {
